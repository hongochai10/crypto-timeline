...
export default function DESStation({ era }: StationProps) {
  ...
  const quizQuestions = getQuizQuestions("des", (key) => tq(key));
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <BenchmarkPanel algorithm="des" color={era.color} />
      ...
      <StationQuiz eraId="des" color={era.color} questions={quizQuestions} />
    </div>
  );
}
